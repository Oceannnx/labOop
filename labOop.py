...
class Sword(Item):
    def __init__(self,hitPower,length):
        super().__init__(hitPower)      #Your code here
        self.length = length    #Your code here set object varibale length = length
...
class Swordman(Human):
    ...
    def __init__(self,height,swardHitPower,length):        
        super().__init__(height)    #Your code here
        self.item = Sword(swardHitPower,length)#Your code here
